...
{
    public class ContactInfoController : BaseMvcController
    {
        private ContactInfoControllerProxy proxy = new ContactInfoControllerProxy();
        ...
        [HttpPost]
        public ActionResult Create(ContactInfoModel model,FormCollection collection)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(ContactInfoModel model,int id, FormCollection collection)
        {
            try
            {
