...
namespace OMSCloud.Web.MVC.Net.Areas.Admin.Controllers
{
    ...
    public class ManageController : BaseMvcController
    {
        ...
        public ActionResult AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            try
            {
                if (this.SendOTP2Phone(UserManager, User.Identity.GetUserId<long>(), model.Number))
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var _retVal = await UserManager.ChangePasswordAsync(User.Identity.GetUserId<long>(), model.OldPassword, model.NewPassword);
