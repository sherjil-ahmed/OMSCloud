!(function (e) {
  ...
  var t = {
    ...
    mMenuToggle: function () {
      e('.mobile-menu-toggler').on('click', function (t) {
        ...
        e('.menu-depart').on('click', function (t) {
          e('body').toggleClass('menu-depart-active'),
            e(this).children('.submenu').toggleClass('opened'),
            t.preventDefault();
        });
    },
    mMenuIcons: function () {
        ...
        n.preventDefault(),
          ...
          e.ajax({
            ...
            success: function (n) {
              var o = e(n);
              setTimeout(function () {
                o.hide().appendTo('.product-ajax-grid').fadeIn(),
                  i.text('Load More'),
                  ++t >= 2 && i.hide();
              }, 350);
            },
      ...
      e('body').on('click', '.btn-add-cart', function (i) {
        if (
          ...
          var n =
            ...
            17 +
            'px';
          e('.sticky-header.fixed').css('margin-right', n),
            e('.sticky-header.fixed-nav').css('margin-right', n),
            e('#scroll-top').css('margin-right', n);
        }
      }),
    ...
    isotopes: function () {
      ...
      e('.filter-button-group').on('click', '.nav-link', function () {
        ...
        n.css('min-height', n.find('.grid-item').outerHeight()),
          t.isotope({ filter: i }),
      ...
      (t.defaults = {
        ...
        (t.prototype = {
          initialize: function (e, t) {
            return e.data('__countdown')
              ? this
              : ((this.$el = e), this.setData().setOptions(t).build(), this);
          },
          setData: function () {
          ...
          setOptions: function (i) {
            return (
              (this.options = e.extend(!0, {}, t.defaults, i, {
                wrapper: this.$el,
              })),
              this
            );
  ...
  function (e) {
    'use strict';
    e.isFunction(e.fn.themePluginCountdown) &&
      e(function () {
