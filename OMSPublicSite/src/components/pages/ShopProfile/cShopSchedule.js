...
class ShopSchedule extends React.Component {
  ...
  successRemoveSchedule = (res) => {
    if (this.ScheduleTypeID == '1') {
      ...
      _MonthlyScheduleList = _MonthlyScheduleList.filter(
        (a) => !(a.ScheduleID == this.ScheduleID),
      );
      this.setState({
  ...
  render() {
    ...
    return (
      <div className="col-lg-9 order-lg-last shopschedule-content">
        <div className="mb-4" />
        {/* margin */}
        <div className="card">
          <div className="card-header">Shop Open Schedule</div>
          <ul>
            <li>  * For Shops of Pick Up/My Service and Local Delivery/Remote Services Only.</li>
            <li>  * If no schedule setup, the Shop is open every day by default.</li>
            <li>  * Schedule will be reflecting on the Shop Calendar and available to the public.</li>
            <li>  * Schedule is only informational to your customers. You can always open Chat with your customers.</li>
          </ul>

          {/* End .card-header */}
          <div className="card-body shop_schedule">
                    ...
                    <div className="form-group">
                      <ul className="ks-cboxtags">
                        <li>
                          ...
                          <span className="label span">Weekly Schedule (Open)</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <ul className="ks-cboxtags">
                        <li>
                          <input
                            ...
                            onChange={this.handleChangeCheckbox}
                          />
                          <label htmlFor="isExceptionWeekly" className="npad" />
                          <span className="label span">Weekly Schedule (Closed)</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  {/*End Form Col-2*/}
                  <div className="col-md-2 att-btn-col toppadding astbn"></div>
                  {/*End Form Col-3*/}
                </div>
                <div className="row justify-content-center">
                  <div className="col-md-10">
                    <ul className="col weekly-tabs">
                      ...
                      >
                        <p className={this.getWeekDayClass('Mon')}>Monday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Tue')}>Tuesday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Wed')}>Wednesday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Thu')}>Thursday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Fri')}>Friday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Sat')}>Saturday</p>
                      </li>
                      <li
                        onClick={() => {
                      ...
                      >
                        <p className={this.getWeekDayClass('Sun')}>Sunday</p>
                      </li>
                    </ul>
                  </div>
                  {/*End Form Col-1*/}
                        ...
                        <tr>
                          ...
                          {(() => {
                            ...
                            for (let x of this.state.weekDays) {
                              ...
                              if (y) {
                                i++;
                                renderObj.push(<td key={i} className="noex" />);
                              } else {
                                i++;
                                renderObj.push(<td key={i} />);
                              }
            ...
            <div className="row marbtm">
              <div className="col-sm-12 npad meo">
                <div className="row justify-content-center">
                  <div className="col-md-5">
                    <div className="form-group">
                      <ul className="ks-cboxtags">
                        <li>
                          ...
                          <span className="label span">Monthly Schedule (Open)</span>
                        </li>
                      </ul>
                      <div className="select-custom">
                        <select
                          ...
                          onChange={(e) => {
                            this.setState({ MonthlyFromDate: e.target.value });
                          }}
                      ...
                      <ul className="ks-cboxtags">
                        <li>
                          ...
                          <label
                            ...
                            className="npad"
                          />
                          <span className="label span">Monthly Schedule (Close)</span>
                        </li>
                      </ul>
                      <div className="select-custom">
                        <select
                          ...
                          name="MonthlyToDate"
                          onChange={(e) => {
                            this.setState({ MonthlyToDate: e.target.value });
                          }}
                        ...
                        >
                          ...
                          {currentMonthDays.map((a, i) => {
                            if (
                              parseInt(a) > parseInt(this.state.MonthlyFromDate)
                            ) {
                              return (
                                <option key={i} value={a}>
                                  {a}
                    ...
                    <div className="form-group">
                      <ul className="ks-cboxtags">
                        <li>
                          ...
                          <span className="label span">Specific Dates (Open)</span>
                        </li>
                      </ul>
                      <div className="select-custom">
                        <select
                      ...
                      <ul className="ks-cboxtags">
                        <li>
                          <input
                            ...
                            onChange={this.handleChangeCheckbox}
                          />
                          <label htmlFor="isExceptionYearly" className="npad" />
                          <span className="label span">Specific Dates (close)</span>
                        </li>
                      </ul>
                      <div className="select-custom">
                        <select
                          ...
                          className="form-control"
                          onChange={(e) => this.handleChangeSpecificDateDay(e)}
