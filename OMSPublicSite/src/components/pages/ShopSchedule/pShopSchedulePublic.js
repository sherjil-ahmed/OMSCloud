...
class ShopSchedulePublic extends React.Component {
  constructor(props) {
    super(props);
    this.resolve = null;
  ...
  render() {
    return (
      <div>
          {this.props.shopDescription ?       <div className="col-lg-12 order-lg-last dashboard-content" >
        <div className="body" >
          <div className="row rrvs">

            <div className="col-lg-12  " > 
                <span style={{fontWeight: 'bold', fontSize: '25px', color: 'black', textDecoration:'underline'}}>More about shop...</span>
...
export default ShopSchedulePublic;
