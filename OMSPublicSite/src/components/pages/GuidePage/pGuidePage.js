...
shop opening wizard will guide you through.</p>
        ...
        <section className="sec5">
          <div className="container">
            <div className="row">
              <div className="col-md-3">
                <p className="bon"><i className="fa fa-comments" aria-hidden="true" /> Still have more questions?</p>
              </div>
              <div className="col-md-3">
                <p><i className="fa fa-envelope" aria-hidden="true" /> Feel free to contact us </p>
              </div>
              <div className="col-md-3">
                <p><i className="fa fa-truck" aria-hidden="true" /> Ready to start?</p>
              </div>
              <div className="col-md-3">
                <p><i className="fa fa-shopping-basket" aria-hidden="true" /> Open your shop</p>
              </div>
            </div>
          </div>
        </section>*/}
