...
class ZonvrTerms extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      FAQsShowHide: {
  ...
  render() {
    return (
      <>
        ...
        {/* <section className="sec1" id="section2">
                <div className="container">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="main-fqs">
                        <div className="q2">
                          <p className="qu2 tds" onClick={()=>{this.showHideDiv("a2")}}>Terms Of Service</p>
                          <div className={this.state.FAQsShowHide.a1 ? "a2 show" : "a2"}   id="a2">
                              <h2>Terms of Service</h2>
                              <p>These Terms of Service govern your use of the website located at <a href="https://www.Zvonr.com">https://www.Zvonr.com</a> and any related services provided by Zvonr.com. </p>
                              <p>By accessing <a href="https://www.Zvonr.com">https://www.Zvonr.com</a>, you agree to abide by these Terms of Service and to comply with all applicable laws and regulations. If you do not agree with these Terms of Service, you are prohibited from using or accessing this website or using any other services provided by Zvonr.com. </p>
                              <p>We, Zvonr.com, reserve the right to review and amend any of these Terms of Service at our sole discretion. Upon doing so, we will update this page. Any changes to these Terms of Service will take effect immediately from the date of publication. </p>
                              <p>These Terms of Service were last updated on 22 May 2021. </p>
                              ...
                              <ol>
                                ...
                                <li>knowingly or negligently use this website or any of its associated services in a way that abuses or disrupts our networks or any other service Zvonr.com provides;</li>
                              ...
                              <p>The intellectual property in the materials contained in this website are owned by or licensed to Zvonr.com and are protected by applicable copyright and trademark law. We grant our users permission to download one copy of the materials for personal, non-commercial transitory use. </p>
                              <p>This constitutes the grant of a license, not a transfer of title. This license shall automatically terminate if you violate any of these restrictions or the Terms of Service, and may be terminated by Zvonr.com at any time. </p>
                              ...
                              <h3>Liability</h3>
                              <p>Our website and the materials on our website are provided on an 'as is' basis. To the extent permitted by law, Zvonr.com makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property, or other violation of rights. </p>
                              <p>In no event shall Zvonr.com or its suppliers be liable for any consequential loss suffered or incurred by you or any third party arising from the use or inability to use this website or the materials on this website, even if Zvonr.com or an authorized representative has been notified, orally or in writing, of the possibility of such damage. </p>
                              ...
                              <p>The materials appearing on our website are not comprehensive and are for general information purposes only. Zvonr.com does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on this website, or otherwise relating to such materials or on any resources linked to this website. </p>
                              <h3>Links</h3>
                              <p>Zvonr.com has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement, approval, or control by Zvonr.com of the site. Use of any such linked site is at your own risk and we strongly advise you make your own investigations with respect to the suitability of those sites. </p>
              ...
              <section className="sec1" id="section3">
                <div className="container">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="main-fqs">
                        <div className="q1">
                          <p className="qu1 tds" onClick={()=>{this.showHideDiv("a3")}}>Cookies Policy</p>
                          <div className={this.state.FAQsShowHide.a1 ? "a3 show" : "a3"}   id="a3">
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <section className="sec1" id="section4">
                <div className="container">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="main-fqs">
                        <div className="q1">
                          <p className="qu1 tds" onClick={()=>{this.showHideDiv("a4")}}>Acceptable Use Policy</p>
                          <div className={this.state.FAQsShowHide.a1 ? "a4 show" : "a4"}   id="a4">
                          </div>
                        </div>
                      </div>
                    </div>
